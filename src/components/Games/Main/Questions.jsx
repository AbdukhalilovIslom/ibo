...
К игровому аккаунту предоставляем все необходимые инструкции, и помогаем с установкой.`,
	...
	return (
		<div className='main-container my-12 grid grid-cols-2 gap-20 max-sm:grid-cols-1 max-sm:gap-8 px-28 max-sm:p-4'>
			<div className='flex flex-col justify-self-start gap-2.5 px-8 py-4 max-sm:p-0'>
