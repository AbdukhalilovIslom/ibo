...
export default function Instructions() {
	...
	const instructions = [
		...
		'Введите сумму, на которую хотите пополнить кошелек PlayStarion или выберите нужную игру.',
		'Проверьте, что указали данные аккаунта верно.',
		'Нажмите кнопку “Оплатить”',
		'Вы перейдете на страницу, где необходимо выбрать метод оплаты.',
		'После успешной оплаты деньги поступят на баланс аккаунтав течение 2-15 минут.',
	];
	const questions = [
		{
