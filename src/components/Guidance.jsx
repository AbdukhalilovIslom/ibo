          ...
          <div className="flex flex-wrap max-sm:justify-center gap-6 lg:gap-12 w-full max-sm:gap-4">
            <div className="bg-white rounded-[20px] flex items-center py-2 px-4 max-sm:py-1.5 max-sm:px-2 border-primary border-1 max-w-xs w-[45%]">
              <div className="flex gap-3">
                ...
                <div className="w-10 h-10 rounded-sm border-1 p-4 flex items-center justify-center border-primary text-3xl font-bold max-sm:w-4 max-sm:h-4 max-sm:p-2 max-sm:text-xs">
                  1
                </div>
              </div>
            </div>
          ...
          <div className="grid grid-cols-2 max-sm:grid-cols-1 gap-x-8 gap-y-2.5 bg-white rounded-3xl border-1 border-primary p-4 flex-1 max-sm:p-4">
            <div className="flex flex-col justify-between">
              ...
              <div className="mb-1">
                ...
                <div className="flex gap-3">
                  <button className="px-4 py-2bg-white text-primary border-primary border-1  rounded-lg font-medium max-sm:text-xs">
                    PS4
                  </button>
                  <button className="px-4 py-2 bg-primary text-white rounded-lg font-medium max-sm:text-xs">
                    PS5
                  </button>
                </div>
              </div>
            ...
            <div className="flex flex-col gap-2">
              ...
              <div className="flex flex-col gap-2.5">
                {durations.map((duration) => (
                  <button
                    ...
                    className={`w-full p-2 text-sm max-sm:text-xs rounded-lg border-1 transition-colors flex justify-between items-center border-primary ${
              ...
              {/* Buy Button */}
              <button className="w-full bg-[#FF4747] hover:bg-[#ff4747c7] text-white py-2 rounded-lg text-lg max-sm:text-sm transition-colors">
                Купить
              </button>
            </div>
