        ...
        <div className="flex flex-col lg:flex-row gap-8">
          ...
          <div className="grid grid-cols-2 max-sm:grid-cols-1 gap-x-8 gap-y-2.5 bg-white rounded-3xl border-1 border-primary p-8 flex-1 max-sm:p-4">
                ...
                <div className="flex gap-3">
                  {tiers.map((tier) => (
                    <button
                      ...
                      className={`py-3 w-28 rounded-lg font-medium transition-colors max-sm:text-[12px] ${
                        selectedTier === tier
            ...
            <div className="flex flex-col gap-2">
              ...
              <div className="flex flex-col gap-2.5">
                {currentTier.durations.map((duration) => (
                  <button
                    ...
                    className={`w-full p-2 text-sm max-sm:text-[12px] rounded-lg border-1 transition-colors flex justify-between items-center border-primary ${
              ...
              {/* Buy Button */}
              <button className="w-full bg-secondary hover:bg-yellow-200 text-black py-2 rounded-lg text-lg max-sm:text-sm transition-colors">
                Купить
              </button>
            </div>
